        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-8 sm:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-8 text-gray-700 leading-relaxed text-sm sm:text-base">
            <div>
              ...
              <p>
                1st Blessed Adult Family Home ("we," "our," or "us") is
                committed to protecting the privacy of those who visit our
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  fill out our contact form, you may provide your name, email
                  address, phone number, and any details you include in your
                  message.
                </li>
                <li>
                  <strong>Automatically collected information:</strong>{" "}
                  Technical information such as IP address, browser type, and
                  pages visited through standard server logs.
                </li>
                <li>
                  <strong>Cookies:</strong> Our Site may use cookies to improve
                  functionality and understand website usage.
                </li>
              </ul>
              <p className="mt-3 text-xs text-gray-500">
                We do not collect sensitive health records or financial data
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  To respond to your enquiries and messages submitted via our
                  contact form
                </li>
                <li>
                  To schedule tours or follow up on care-related questions
                </li>
