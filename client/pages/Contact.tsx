...
const CONTACT_DETAILS: {
...
}[] = [
  {
    icon: MapPin,
    label: "Home Address",
    value: "6007 Rockefeller Ave, Everett, WA 98203",
  },
  {
    icon: Phone,
    label: "Phone Number",
  ...
  { icon: Printer, label: "Fax Line", value: "425-493-3277" },
  {
    icon: Clock,
    label: "Tours & Visits",
    value: "7 days a week (by appointment)",
  },
];

const INPUT_CLS =
  "w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-navy-800 text-sm";
const LABEL_CLS =
  "block text-xs font-semibold text-navy-950 uppercase tracking-wider mb-2";
      ...
      <section className="bg-navy-950 text-white py-16 sm:py-24 border-b border-navy-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            No phone trees, no automated call centers. Connect directly with our
            caregivers in Everett, WA.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-7 bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 text-sm mb-8">
                Fill out the form below to enquire about availability, schedule
                a private tour, or ask care questions.
              </p>
              ...
              {submitted ? (
                <div className="bg-gold-50 border border-gold-500/30 p-8 rounded-xl text-center space-y-4">
                  ...
                  <p className="text-gray-700 text-sm">
                    We have received your message. A member of the 1st Blessed
                    Care Team will respond promptly.
                  </p>
                  <Button
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6">
                <h3 className="text-xl font-bold text-navy-950 border-b border-gray-100 pb-4">
