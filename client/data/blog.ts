...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "One of the hardest conversations a family has. Here are compassionate, practical ways to approach it — and what to avoid saying.",
    content: [
  ...
  },
  {
    ...
    excerpt: "Research and experience both point in the same direction: familiar environments, consistent faces, and calm routines make a measurable difference in dementia outcomes.",
    content: [
  ...
  },
  {
    ...
    readTime: "6 min read",
    category: "FAMILY GUIDES",
    excerpt: "Touring a potential care home can feel overwhelming. This checklist helps you know what to look for — and what red flags to watch out for.",
    content: [
  ...
  },
  {
    ...
    readTime: "5 min read",
    category: "CARE & EDUCATION",
    excerpt: "Medication errors are one of the most common and preventable risks in senior care. Here's how a structured adult family home approach reduces that risk.",
    content: [
  ...
  },
  {
    ...
    readTime: "5 min read",
    category: "CARE & EDUCATION",
    excerpt: "Social connection is essential for emotional and mental health. Staying engaged helps seniors maintain a sense of purpose, cognition, and joy.",
    content: [
  ...
  },
  {
    ...
    readTime: "8 min read",
    category: "FAMILY GUIDES",
    excerpt: "Preparing for a parent's move-in doesn't need to be stressful. Here's a practical, room-by-room list of what to bring and what to leave at home.",
    content: [
  ...
  },
  {
    ...
    readTime: "5 min read",
    category: "CARE & EDUCATION",
    excerpt: "At 1st Blessed Adult Family Home in Everett, every day combines professional senior care with the genuine warmth of home.",
    content: [
