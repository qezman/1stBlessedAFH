...
const CONTACT_ITEMS = [
  ...
  { icon: Mail, text: '1stblessedafh@gmail.com', href: 'mailto:1stblessedafh@gmail.com' },
    ...
    <footer className="bg-navy-950 text-white pt-16 pb-8 border-t border-navy-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <div>
                <span className="block font-bold text-lg text-white leading-tight">1st Blessed</span>
                <span className="block text-xs font-medium text-gold-400 tracking-wider uppercase">Adult Family Home</span>
              </div>
            </Link>
            <p className="text-sm text-gray-300 leading-relaxed">
              A warm, licensed adult family home in Everett, WA providing personalized 24-hour care for up to six residents.
            </p>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gold-400 tracking-wider uppercase mb-4">Quick Links</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gold-400 tracking-wider uppercase mb-4">Our Services</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gold-400 tracking-wider uppercase mb-4">Contact & Location</h3>
            <ul className="space-y-3 text-sm text-gray-300">
              {CONTACT_ITEMS.map(({ icon: Icon, text, href }) => (
                <li key={text} className="flex items-start space-x-3">
                  ...
                  {href ? (
                    <a href={href} className="hover:text-gold-400 transition-colors">{text}</a>
                  ) : (
        ...
        <div className="pt-8 border-t border-navy-800/80 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 space-y-4 md:space-y-0">
          <p>© {new Date().getFullYear()} 1st Blessed Adult Family Home. All rights reserved.</p>
          <div className="flex space-x-6">
            <Link to="/privacypolicy" className="hover:text-gold-400 transition-colors">Privacy Policy</Link>
            <Link to="/terms-of-use" className="hover:text-gold-400 transition-colors">Terms of Use</Link>
          </div>
        </div>
      </div>
    </footer>
