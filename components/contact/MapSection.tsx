...
export function MapSection() {
  return (
    <div className="bg-gray-50 border-t border-gray-200">
      {/* Address bar */}
      <div className="max-w-[1200px] mx-auto px-6 sm:px-12 py-8 sm:py-9 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
        ...
        <a
          ...
          className="inline-flex w-full sm:w-auto items-center justify-center gap-2 bg-[#1A3358] hover:bg-[#122240] text-white text-[13px] font-medium px-5 py-3 rounded transition-colors flex-shrink-0 group"
        >
      ...
      <iframe
        ...
        className="w-full h-[300px] sm:h-[400px] border-none block"
